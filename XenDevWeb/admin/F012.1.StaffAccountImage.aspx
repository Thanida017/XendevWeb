<%@ Page Language="C#" 
    ...
    CodeBehind="F012.1.StaffAccountImage.aspx.cs" 
    Inherits="XenDevWeb.admin.F012__1_StaffAccountImage" 
                    ...
                    <section class="panel">
                        <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                            <span class="hidden-sm wht-color">
                                <strong><asp:Label ID="lblImageCustomer" runat="server" meta:resourcekey="lblImageCustomerRc" /></strong>
                            </span>
                        </header>
                                ...
                                <form id="myForm" role="form" runat="server" enctype="multipart/form-data">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>   
                                            ...
                                            <asp:HiddenField ID="hndSAId" runat="server" />
                                        </ContentTemplate>
                                        <Triggers>
