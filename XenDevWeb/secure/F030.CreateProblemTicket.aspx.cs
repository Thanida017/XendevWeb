...
{
    public partial class F030_CreateProblemTicket : CRUDPageControler
    {
        ...
        protected void lnkUpload_ServerClick(object sender, EventArgs e)
        {
            ...
            if (file == null)
            {
                this.errorMessagesForUpload.Add(HttpContext.GetLocalResourceObject("~/secure/F030.CreateProblemTicket.aspx",
                                                                                   "pls_upload_image",
                                                                                    culture).ToString());
                return;
            }
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            Ticket someoneTicketNumber = this.ticketDAO.findByTicketNumberTicketTypeClient(this.txtTicketNumber.Text, false);
            if (someoneTicketNumber != null)
            {
                string mesg = string.Format(HttpContext.GetLocalResourceObject("~/secure/F030.CreateProblemTicket.aspx",
                                                                                "ticketNumber_in_use",
                                                                                culture)
                                                                                .ToString(),
            ...
            ticket.ticket_type = TICKET_TYPE.CLIENT;
            ticket.requester = sa;
            ...
            {
                this.errorMessagesForCreate.Add(HttpContext.GetLocalResourceObject("~/secure/F030.CreateProblemTicket.aspx",
