<%@ Page Language="C#" 
    ...
    CodeBehind="F030.CreateProblemTicket.aspx.cs" 
    Inherits="XenDevWeb.secure.F030_CreateProblemTicket" 
                    ...
                    <section class="panel">
                        <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                            <span class="hidden-sm wht-color">
                                <strong>
                                    <asp:Label ID="lblAddProblemTicket" runat="server" meta:resourcekey="lblAddProblemTicketRc" /></strong>
                            </span>
                        </header>
