...
{
    public partial class F011_ApplicationChangeTrxEdit : CRUDPageControler
    {
        ...
        {
            Response.Redirect("F009.1.ChangeRequestDetails.aspx?acId=" + HttpUtility.UrlEncode(QueryStringModule.Encrypt(hndACId.Value)), true);
            return;
        }
    }
}