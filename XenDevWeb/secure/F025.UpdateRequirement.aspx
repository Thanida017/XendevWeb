<%@ Page Language="C#" 
    ...
    CodeBehind="F025.UpdateRequirement.aspx.cs" 
    Inherits="XenDevWeb.secure.F025_UpdateRequirement" 
                    ...
                    <section class="panel">
                        <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                            <span class="hidden-sm wht-color">
                                <strong>
                                    <asp:Label ID="lblUpdateRequirements" runat="server" meta:resourcekey="lblUpdateRequirementsRc" />
                                </strong>
                            </span>
                        </header>
                                        ...
                                        <ContentTemplate>
                                            ...
                                            <section class="panel" style="border: solid 1px #d0efde">
                                                <header class="panel-heading">
                                                    <b>
                                                        <asp:Label ID="lblUpdateRequirementsHeader" runat="server" meta:resourcekey="lblUpdateRequirementsRc" />
                                                    </b>
                                                </header>
                                                        ...
                                                        <div class="col-lg-2 col-md-3 col-xs-12" style="padding: 5px;">
                                                            <div class="form-group" style="width: 100%; float: left">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="rfvTitle"
                                                                                            runat="server"
                                                                                            ValidationGroup="vsUpdateRequirmentGroup"
                                                        ...
                                                        <div class="col-lg-2 col-md-3 col-xs-12" style="padding: 5px; float: right">
                                                            <div class="form-group" style="width: 100%; margin-top: 22px; float: left">
                                                                <asp:LinkButton ID="btnUpdate"
                                                                       ...
                                                                       <asp:PlaceHolder runat="server">
                                                                            <asp:Label ID="lblUpdate" runat="server" meta:resourcekey="lblBtnUpdateRc"></asp:Label>
                                                                       </asp:PlaceHolder>
                                                                </asp:LinkButton>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-2 col-md-3 col-xs-12" style="padding: 5px; float: right" id="release" runat="server">
                                                            <div class="form-group" style="width: 100%; margin-top: 22px; float: left">
                                                                <asp:LinkButton ID="btnRelease"
                                                                                type="button"
                                                                                class="btn btn-primary btn-block"
                                                                                runat="server"
                                                                                OnClick="btnRelease_Click">
                                                                    <asp:PlaceHolder runat="server">
                                                                        <asp:Label ID="lblBtnRelease" runat="server" meta:resourcekey="lblBtnReleaseRc"></asp:Label>
                                                                    </asp:PlaceHolder>                                                                 
                                                                </asp:LinkButton>
                                                            </div>
                                                        </div>
                                            ...
                                            <asp:HiddenField ID="hndNewCreate" runat="server" />
                                        </ContentTemplate>
                                        <Triggers>
                                        </Triggers>
                                    </asp:UpdatePanel>
