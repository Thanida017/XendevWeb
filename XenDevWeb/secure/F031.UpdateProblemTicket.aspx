<%@ Page Language="C#" 
    ...
    CodeBehind="F031.UpdateProblemTicket.aspx.cs" 
    Inherits="XenDevWeb.secure.F031_UpdateProblemTicket" 
                    ...
                    <section class="panel">
                        <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                            <span class="hidden-sm wht-color">
                                <strong>
                                    <asp:Label ID="lblUpdateProblemTicket" runat="server" meta:resourcekey="lblUpdateProblemTicketRc" /></strong>
                            </span>
                        </header>
                        <div class="panel-body">
                            <div class="tab-content">
                                <form id="myForm" role="form" runat="server">
                                    ...
                                    <section class="panel">
                                        <div class="row">
                                            <asp:UpdatePanel ID="pnlUpdateTicket" runat="server" UpdateMode="Conditional">
                                                <ContentTemplate>
                                                                            ...
                                                                            <div class="col-lg-4 col-md-4 col-xs-6" style="padding: 5px;">
                                                                                <div class="form-group" style="width: 100%; float: left">
                                                                                    ...
                                                                                    <asp:RequiredFieldValidator ID="rfvTicketNumber"
                                                                                                                runat="server"
                                                                                                                ValidationGroup="vsUpdateTicketGroup"
                                                                ...
                                                                <section class="panel" style="border: solid 1px #d0efde">
                                                                    ...
                                                                    <asp:Panel runat="server" class="panel-body" Style="padding-bottom: 0px" DefaultButton="">
                                                                        <div class="panel-body" style="overflow-x: auto; height: 125px;">
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateField ItemStyle-Width="5%" meta:resourcekey="assignmentToGridView_AssignToIDRc" Visible="false">
                                                                                        <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="hndTicketUpdateId" runat="server" />
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-xs-12">
                                                        ...
                                                        <asp:HiddenField ID="hndImgId" runat="server" />
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-xs-12">
                                                        <section class="panel" style="border: solid 1px #d0efde">
                                                            <header class="panel-heading">
                                                            ...
                                                            <asp:Panel runat="server" class="panel-body" Style="padding-bottom: 0px" DefaultButton="">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2 col-md-2 col-xs-6" style="padding: 5px;float: right;" runat="server" id="divBtnAssign">
                                                                        <div class="form-group" style="width: 100%; margin-top: 22px; float: left">
                                                                            <asp:LinkButton ID="btnAssigned"
                                                                                            type="button"
                                                                                            class="btn btn-primary btn-block"
                                                                                            runat="server"
                                                                                            OnClick="btnAssigned_Click">
                                                                                <i class="fa fa-cloud-upload"></i>
                                                                                <asp:Label ID="lblBtnAssigned" runat="server" meta:resourcekey="lblBtnAssignedRc"></asp:Label>
                                                                            </asp:LinkButton>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <asp:HiddenField ID="hndImgItemID" runat="server" />
                                                </ContentTemplate>
                                                <Triggers>
