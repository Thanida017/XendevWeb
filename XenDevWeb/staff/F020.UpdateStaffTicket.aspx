<%@ Page Language="C#" 
    ...
    CodeBehind="F020.UpdateStaffTicket.aspx.cs" 
    Inherits="XenDevWeb.staff.F020_UpdateStaffTicket" 
                    ...
                    <section class="panel">
                        <header class="panel-heading tab-bg-dark-navy-blue tab-right ">
                            <span class="hidden-sm wht-color">
                                <strong>
                                    <asp:Label ID="lblUpdateTicket" runat="server" meta:resourcekey="lblUpdateTicketRc" /></strong>
                            </span>
                        </header>
