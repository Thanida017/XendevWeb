<%@ Page Language="C#" 
    ...
    CodeBehind="TestDrawflowDynamic.aspx.cs" 
    ValidateRequest="false"
    Inherits="XenDevWeb.Test.drawflow.TestDrawflowDynamic" %>
        ...
        <div class="wrapper" style="margin: 1px">
            <div class="col">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <p style="width:90%; margin:10px;">Select Node</p>
                        <select id="selNode" style="width:90%; margin:10px;border-radius: 10px; padding:10px;">
                        ...
                        <p style="width: 90%; margin: 0px 0px 0px 10px;">Title</p>
                        <asp:TextBox ID="txtTitle" runat="server" meta:resourcekey="txtTitleRc" Style="width: 80%; margin: 10px; border-radius: 10px; padding: 10px;"></asp:TextBox>
                        <p style="width: 90%; margin: 0px 0px 0px 10px;">Text</p>
                        <asp:TextBox ID="txtText" runat="server" meta:resourcekey="txtTextRc" Style="width: 80%; margin: 10px; border-radius: 10px; padding: 10px;"></asp:TextBox>
                        <p style="width: 90%; margin: 0px 0px 0px 10px;">Port Left</p>
                        <asp:TextBox ID="txtPortLeft" runat="server" TextMode="Number" min="0" Text="0" Style="width: 80%; margin: 10px; border-radius: 10px; padding: 10px;"></asp:TextBox>
                        <p style="width: 90%; margin: 0px 0px 0px 10px;">Port Right</p>
